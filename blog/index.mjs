...
function createReactiveSystem({
  ...
  return {
    ...
    updateDirtyFlag: updateDirtyFlag2,
    startTracking: startTracking2,
    endTracking: endTracking2,
    processEffectNotifications: processEffectNotifications2,
    processComputedUpdate: processComputedUpdate2,
    processPendingInnerEffects: processPendingInnerEffects2
  };
  ...
  function propagate2(current) {
    ...
    top: do {
      ...
      if (!(subFlags & (4 /* Tracking */ | 16 /* Recursed */ | 224 /* Propagated */))) {
      ...
      } else if (!(subFlags & targetFlag) && subFlags & 224 /* Propagated */ && isValidLink(current, sub)) {
  ...
  function updateDirtyFlag2(sub, flags) {
  ...
  function processComputedUpdate2(computed2, flags) {
    if (flags & 32 /* Dirty */ || checkDirty(computed2.deps)) {
  ...
  function processPendingInnerEffects2(sub, flags) {
  ...
  function processEffectNotifications2() {
  ...
  function shallowPropagate(link3) {
    do {
      const sub = link3.sub;
      const subFlags = sub.flags;
